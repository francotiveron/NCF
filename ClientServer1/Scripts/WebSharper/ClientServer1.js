...
{
 "use strict";
 var Global,ClientServer1,Client,WebSharper,UI,Next,Var,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 Global=window;
 ClientServer1=Global.ClientServer1=Global.ClientServer1||{};
 Client=ClientServer1.Client=ClientServer1.Client||{};
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("ClientServer1:ClientServer1.Server.DoSomething:-1287498065",[a.$0]):(b=null,Concurrency.Delay(function()
   {
