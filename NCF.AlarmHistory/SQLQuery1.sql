...
CREATE ASSEMBLY [FSharp.Core] FROM 'C:\Root\Project\NCF\packages\FSharp.Core.4.3.4\lib\net45\FSharp.Core.dll' WITH PERMISSION_SET = UNSAFE
...
CREATE ASSEMBLY [System.Data.DataSetExtensions] FROM 'C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Data.DataSetExtensions.dll' WITH PERMISSION_SET = UNSAFE
GO
