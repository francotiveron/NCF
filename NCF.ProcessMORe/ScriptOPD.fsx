...
type dbSchema = SqlDataConnection<"Data Source=aunpmsql1.npm.local;Initial Catalog=OPD_ProcessMORe;Integrated Security=False;Connect Timeout=30;user=downtime;password=downtime;ApplicationIntent=ReadWrite">
